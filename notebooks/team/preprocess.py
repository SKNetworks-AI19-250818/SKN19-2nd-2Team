...
# 이곳에 담당 모듈 임포트 추가
from features_01 import feature_age_group, feature_is_single, feature_house_income, feature_dementia_case, feature_smoke_avg_per_day
